...
<body class="bg-[#0F1117] font-body text-[#94A3B8] antialiased selection:bg-[#6C63FF]/30">

    {{-- ===== Barra de progreso de lectura ===== --}}
    <div id="scroll-progress" class="fixed left-0 top-0 z-[60] h-1 w-0 bg-gradient-to-r from-[#6C63FF] to-[#00D4FF] transition-[width] duration-150"></div>

    {{-- ===== Barra de navegación (fija arriba) ===== --}}
    <header id="site-header" class="fixed inset-x-0 top-0 z-50 border-b border-[#2A3142] bg-[#0F1117]/80 font-body backdrop-blur-lg transition-shadow duration-300">
    ...
    {{-- ===== Pie de página ===== --}}
    <footer class="bg-[#0B0D13] text-[#94A3B8]">
        <div class="mx-auto max-w-6xl px-6 py-14">
            <div class="grid gap-10 md:grid-cols-3">
                ...
                <div>
                    ...
                    <div class="mt-5 flex gap-3">
                        <a href="https://wa.me/56987873015" target="_blank" rel="noopener" aria-label="WhatsApp" class="grid size-9 place-items-center rounded-full bg-white/5 transition hover:bg-[#6C63FF] hover:text-white">
                        ...
                        <a href="#" aria-label="Instagram" class="grid size-9 place-items-center rounded-full bg-white/5 transition hover:bg-[#6C63FF] hover:text-white">
                        ...
                        <a href="#" aria-label="Facebook" class="grid size-9 place-items-center rounded-full bg-white/5 transition hover:bg-[#6C63FF] hover:text-white">
            ...
            <div class="mt-12 border-t border-[#2A3142] pt-6 text-center text-sm text-[#64748B]">
