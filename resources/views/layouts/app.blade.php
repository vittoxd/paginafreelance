        ...
        <div class="mx-auto max-w-6xl px-6 py-14">
            <div class="grid gap-10 md:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2 text-sm">
                        <li><a href="mailto:hola@tudominio.com" class="transition hover:text-white">hola@tudominio.com</a></li>
                        <li><a href="https://wa.me/56912345678" target="_blank" rel="noopener" class="transition hover:text-white">+56 9 1234 5678</a></li>
                    </ul>
                    <div class="mt-5 flex gap-3">
                        <a href="https://wa.me/56912345678" target="_blank" rel="noopener" aria-label="WhatsApp" class="grid size-9 place-items-center rounded-full bg-white/10 transition hover:bg-blue-600 hover:text-white">
